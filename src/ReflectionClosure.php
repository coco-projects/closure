...
class ReflectionClosure extends ReflectionFunction
{
    ...
    public function getCode()
    {
        ...
        $_class     = var_export(trim((string)$className, '\\'), true);
        $_function  = $ns . ($ns == '' ? '' : '\\') . '{closure}';
        $_method    = ($className == '' ? '' : trim((string)$className, '\\') . '::') . $_function;
                    ...
                    switch ($token[0]) {
                        case T_NAME_QUALIFIED:
                            [
                                ...
                                $id_start_ci,
                                $id_name,
                            ] = $this->parseNameQualified($token[1]);
                            $context   = 'args';
                            $state     = 'id_name';
...
' . PHP_EOL;
    ...
    private function parseNameQualified($token): array
    {
